...
-- -----------------------------------------------------
-- Table `full-stack`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `full-stack`.`product_category` (
...
-- -----------------------------------------------------
-- Table `full-stack`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `full-stack`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
